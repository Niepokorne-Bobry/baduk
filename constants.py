...
SIZE = __root.winfo_screenheight() * 0.7  # zmienna do rozmiaru boku czyli dlugosci kwadtatów wynaczonych przez linie gdy mamy np 3 linie to dziela one bok na 4 czesci wiec 9 linii to 10 kwadratów
...
CIRCLE_RADIUS = LINE_LENGTH * 0.4
CIRCLE_WIDTH = 5

CLICKABLE_FIELD_SIZE = LINE_LENGTH / 7  # ilosc pixeli w kazdym kierunku od wspolrzednych punktu - zasięg przypisania kamienia do pola
